...
2026-06-02 版本 0.5.1    支持无损与云盘播放；修复模糊搜索/日推登出/缓存 KeyError、中文搜索退格 UnicodeDecodeError、无曲时按 i 误开歌曲页、macOS 退格显示 ^? 等问题

2026-06-02 版本 0.5.0    项目现代化重启：Python 3.10+、Ruff 工具链、依赖升级
